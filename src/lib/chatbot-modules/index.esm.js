...
import React__default, { useRef, cloneElement, version, isValidElement, useImperativeHandle, useEffect, memo, forwardRef, useState, useMemo as useMemo$1, createElement, useCallback } from 'react';
...
const MessageComponent = memo(({ item, className = '', textMessageOverride, imageMessageOverride, videoMessageOverride, textMessageProps, imageMessageProps, videoMessageProps, timeLabelProps, avatarProps, }) => {
...
const MessageListComponent = forwardRef(({ messages = [], conversationId = '', className = '', onLoadMorePreviousData, cache = false, showScrollToEndButton = true, virtuosoProps, scrollToEndButtonProps, emptyDataComponent, isPrevLoading = false, isPrevLoadingComponent, customMessageComponentProps, }, ref) => {

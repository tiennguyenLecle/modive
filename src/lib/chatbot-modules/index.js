...
const ChatboxComposer = ({ className = '', beforeComposer, afterComposer, sendButtonComponent, textareaProps, ...props }) => {
    const textareaRef = React.useRef(null);
    return (jsxRuntimeExports.jsxs("div", { className: `${styles$1.chatboxComposer} ${className}`, ...props, children: [beforeComposer, jsxRuntimeExports.jsxs("div", { className: "c-chatbox-composer-input-container", children: [jsxRuntimeExports.jsx(Textarea, { ...textareaProps, ref: textareaRef, className: "c-chatbox-composer-textarea" }), jsxRuntimeExports.jsx(Button, { ...sendButtonComponent, className: "c-chatbox-composer-button", onClick: () => {
...
const MessageComponent = React.memo(({ item, className = '', textMessageOverride, imageMessageOverride, videoMessageOverride, textMessageProps, imageMessageProps, videoMessageProps, timeLabelProps, avatarProps, }) => {
    ...
    return (jsxRuntimeExports.jsx("div", { className: `${styles.msgComponent} c-msg-component c-msg-${speakerType} c-message-${align} ${className}`, children: contentOverride || (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [avatarUrl && (jsxRuntimeExports.jsx(Avatar, { className: "c-msg-avatar", src: avatarUrl, ...avatarProps })), jsxRuntimeExports.jsxs("div", { className: "c-msg-content", children: [jsxRuntimeExports.jsx("div", { className: "c-msg-name", children: name }), messageArray && messageArray?.length > 0 ? (messageArray?.map((item, index) => {
                            return (jsxRuntimeExports.jsx("div", { className: "c-msg-line", children: handleRenderContentByType(item) }, index));
...
const MessageListComponent = React.forwardRef(({ messages = [], conversationId = '', className = '', onLoadMorePreviousData, cache = false, showScrollToEndButton = true, virtuosoProps, scrollToEndButtonProps, emptyDataComponent, isPrevLoading = false, isPrevLoadingComponent, customMessageComponentProps, }, ref) => {
    ...
    const Row = ({ index }) => {
        return (jsxRuntimeExports.jsx(MessageComponent, { ...customMessageComponentProps, className: "c-message-item", item: msgs[index] }));
    };

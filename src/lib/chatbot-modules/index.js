...
const ChatboxComposer = ({ className = '', sendButtonComponent, beforeComposerOutsideComponent, afterComposerOutsideComponent, beforeComposerInsideComponent, afterComposerInsideComponent, textareaProps, ...props }) => {
    const textareaRef = React.useRef(null);
    return (jsxRuntimeExports.jsxs("div", { className: `${styles$1.chatboxComposer} ${className}`, ...props, children: [beforeComposerOutsideComponent && (jsxRuntimeExports.jsx(Button, { className: "c-chatbox-composer-before-outside", isDisabled: beforeComposerOutsideComponent?.isDisabled, onClick: beforeComposerOutsideComponent?.onClick, children: beforeComposerOutsideComponent?.children, ...beforeComposerOutsideComponent })), jsxRuntimeExports.jsx(Textarea, { ...textareaProps, startIcon: beforeComposerInsideComponent ? (jsxRuntimeExports.jsx(Button, { className: "c-chatbox-composer-before-inside", isDisabled: beforeComposerInsideComponent?.isDisabled, onClick: beforeComposerInsideComponent?.onClick, children: beforeComposerInsideComponent?.children, ...beforeComposerInsideComponent })) : undefined, endIcon: afterComposerInsideComponent ? (jsxRuntimeExports.jsx(Button, { className: "c-chatbox-composer-after-inside", isDisabled: afterComposerInsideComponent?.isDisabled, onClick: afterComposerInsideComponent?.onClick, children: afterComposerInsideComponent?.children, ...afterComposerInsideComponent })) : undefined, ref: textareaRef, className: "c-chatbox-composer-textarea" }), afterComposerOutsideComponent && (jsxRuntimeExports.jsx(Button, { ...afterComposerOutsideComponent, isDisabled: afterComposerOutsideComponent?.isDisabled, onClick: afterComposerOutsideComponent?.onClick, className: "c-chatbox-composer-after-outside", children: afterComposerOutsideComponent?.children })), jsxRuntimeExports.jsx(Button, { ...sendButtonComponent, isDisabled: sendButtonComponent?.isDisabled, className: "c-chatbox-composer-send-button", onClick: () => {
...
function _e(t, e, n) {
  const o = React.useRef(null), r = React.useCallback(
    (c) => {
    ...
    [t, e]
  ), { callbackRef: s, ref: i } = Ge(r, true, n), l = React.useCallback(() => {
    r(i.current);
  }, [r, i]);
...
function qe(t, e, n) {
  const o = Object.keys(e.required || {}), r = Object.keys(e.optional || {}), s = Object.keys(e.methods || {}), i = Object.keys(e.events || {}), l = React.createContext({});
  function c(d, u) {
  ...
  const S = React.forwardRef((d, u) => {
    const { children: T, ...R } = d, [I] = React.useState(() => ve(Io(t), (k) => {
      c(k, R);
    ...
    const b = n;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(l.Provider, { value: I, children: n ? /* @__PURE__ */ jsxRuntimeExports.jsx(b, { ...Qo([...o, ...r, ...i], R), children: T }) : T });
  }), g = (d) => {
    ...
    const T = React.useContext(l)[d], R = React.useCallback(
      (I) => K(T, I),
      [T]
    );
    ...
    const T = React.useContext(l)[d], [R, I] = React.useState(un(st, T));
    return pe(
      () => K(T, (f) => {
        f !== R && I(cn$1(f));
      }),
...
const be = React.createContext(void 0), Zn = React.createContext(void 0), Xn = typeof document < "u" ? React.useLayoutEffect : React.useEffect;
function ke(t) {
  return "self" in t;
}
function tr(t) {
...
const er = /* @__PURE__ */ U(() => {
  ...
  ([t, e]) => ({ ...t, ...e }),
  X(Yn, er)
), or = ({ height: t }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: t } }), rr = { overflowAnchor: "none", position: Ye(), zIndex: 1 }, Qn = { overflowAnchor: "none" }, sr = { ...Qn, display: "inline-block", height: "100%" }, Cn = /* @__PURE__ */ React.memo(function({ showTopList: e = false }) {
  ...
  return !e && n.totalCount === 0 && R ? /* @__PURE__ */ jsxRuntimeExports.jsx(R, { ...q(R, p) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
    f,
    {
      ...q(f, p),
      ...
      children: (e ? n.topItems : n.items).map((B) => {
        ...
        ) : B.type === "group" ? /* @__PURE__ */ React.createElement(
          k,
          {
            ...q(k, p),
            "data-index": Y,
...
const ur = /* @__PURE__ */ React.memo(function() {
  ...
  return e ? /* @__PURE__ */ jsxRuntimeExports.jsx(o, { ref: r, children: /* @__PURE__ */ jsxRuntimeExports.jsx(e, { ...q(e, s) }) }) : null;
...
function Xe({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return React.memo(function({ children: s, style: i, ...l }) {
    ...
    return t("scrollTo", m), t("scrollBy", w), /* @__PURE__ */ jsxRuntimeExports.jsx(
      a,
      {
...
function Je({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return React.memo(function({ children: s, style: i, ...l }) {
    const c = n("windowScrollContainerState"), a = e("ScrollerComponent"), p = n("smoothScrollTargetReached"), S = e("totalListHeight"), g = e("deviation"), h = e("customScrollParent"), w = e("context"), v = React.useRef(null), m = e("scrollerRef"), { scrollByCallback: d, scrollerRef: u, scrollToCallback: T } = Jn(
      c,
      p,
      a,
      m,
    ...
    }, [u, h]), t("windowScrollTo", T), t("scrollBy", d), /* @__PURE__ */ jsxRuntimeExports.jsx(
      a,
      {
        ref: v,
        "data-virtuoso-scroller": true,
...
const dr = ({ children: t }) => {
  const e = React.useContext(be), n = gt("viewportHeight"), o = gt("fixedItemHeight"), r = M("alignToBottom"), s = M("horizontalDirection"), i = React.useMemo(
    () => ne(n, (c) => wt(c, s ? "width" : "height")),
    [n, s]
  ), l = Ht(i, true, M("skipAnimationFrameInResizeObserver"));
  return React.useEffect(() => {
    e && (n(e.viewportHeight), o(e.itemHeight));
  }, [e, n, o]), /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-viewport-type": "element", ref: l, style: Zt(r), children: t });
}, fr = ({ children: t }) => {
  const e = React.useContext(be), n = gt("windowViewportRect"), o = gt("fixedItemHeight"), r = M("customScrollParent"), s = _e(
    n,
    r,
    M("skipAnimationFrameInResizeObserver")
  ), i = M("alignToBottom");
  ...
  }, [e, n, o]), /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-viewport-type": "window", ref: s, style: Zt(i), children: t });
}, mr = ({ children: t }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(i, { ...e, ...q(i, s), children: [
    o && /* @__PURE__ */ jsxRuntimeExports.jsx(mr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cn, { showTopList: true }) }),
  ...
  const t = C((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
    "Item $",
    a
  ] })), e = C(null), n = C((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { colSpan: 1e3, children: [
    "Group ",
    a
...
const Or = /* @__PURE__ */ U(() => {
  ...
  }, [e]), v ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(
    a,
    {
      className: n,
      ref: d,
  ...
  const e = React.useContext(Zn), n = It("itemDimensions"), o = It("viewportDimensions"), r = Ht(
    React.useMemo(
      () => (s) => {
  ...
  }, [e, o, n]), /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: r, style: Zt(false), children: t });
}, Mr = ({ children: t }) => {
  const e = React.useContext(Zn), n = It("windowViewportRect"), o = It("itemDimensions"), r = et("customScrollParent"), s = _e(n, r, false);
  return React.useEffect(() => {
    e && (o({ height: e.itemHeight, width: e.itemWidth }), n({ offsetTop: 0, visibleHeight: e.viewportHeight, visibleWidth: e.viewportWidth }));
  }, [e, n, o]), /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: s, style: Zt(false), children: t });
}, Wr = /* @__PURE__ */ React.memo(function({ ...e }) {
  const n = et("useWindowScroll"), o = et("customScrollParent"), r = o || n ? Nr : _r, s = o || n ? Mr : Ar, i = et("context");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(r, { ...e, ...q(r, i), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(s, { children: [
...
const MessageComponent = React.memo(({ item, className = '', textMessageOverride, imageMessageOverride, videoMessageOverride, textMessageProps, imageMessageProps, videoMessageProps, timeLabelProps, avatarProps, responseLoadingComponent, }) => {
    ...
    const handleRenderContentByType = (item) => {
        ...
        switch (type) {
            case 'text':
                return (jsxRuntimeExports.jsx("div", { className: "c-msg-text", children: textMessageOverride ||
                        (messageContent && (jsxRuntimeExports.jsx(TextMessage, { className: "c-msg-text-line", ...textMessageProps, message: messageContent }))) }));
            case 'image':
                return (imageMessageOverride || (jsxRuntimeExports.jsx(ImageMessage, { className: "c-msg-image", ...imageMessageProps, imageUrl: imageUrl ?? '' })));
            case 'video':
                return (videoMessageOverride || (jsxRuntimeExports.jsx(VideoMessage, { className: "c-msg-video", ...videoMessageProps, children: videoMessageContent })));
            case 'loading':
                return responseLoadingComponent || jsxRuntimeExports.jsx("div", { children: "Loading..." });
            default:
                return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: message });
        }
    };
    return (jsxRuntimeExports.jsx("div", { className: `${styles.msgComponent} c-msg-component c-msg-${speakerType} c-message-${align} ${className}`, children: contentOverride || (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [avatarUrl && (jsxRuntimeExports.jsx(Avatar, { className: "c-msg-avatar", src: avatarUrl, ...avatarProps })), jsxRuntimeExports.jsxs("div", { className: "c-msg-content", children: [jsxRuntimeExports.jsx("div", { className: "c-msg-name", children: name }), messageArray && messageArray?.length > 0 ? (messageArray?.map((item1, index1) => {
                            return (jsxRuntimeExports.jsx("div", { className: "c-msg-line", children: handleRenderContentByType(item1) }, index1));
                        })) : (jsxRuntimeExports.jsx("div", { className: "c-msg-line", children: handleRenderContentByType({
                                type: 'text',
                                message,
                            }) }))] }), createdAt && (jsxRuntimeExports.jsx(TimeLabel, { ...timeLabelProps, className: "c-msg-timestamp", time: createdAt }))] })) }));
}, (prev, next) => prev?.item?.id === next?.item?.id &&
    prev?.item?.message === next?.item?.message);

const DEFAULT_AVATAR_IMAGE_URL = 'https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png';
const sampleMessages = [
    ...
    },
    {
        ...
        name: 'Bubu Chacha',
        message: '::image{id=f8u85GSs5A}Just took this while reading my favorite book! Maybe we could find something we both enjoy talking about? 😊',
        createdAt: '09:32 pm',
...
const useMessageCache = (conversationId, initial, cache) => {
    ...
    const saveToCache = React.useCallback((msgs) => {
        if (!cache)
            return;
        memoryCache.set(conversationId, msgs);
        if (cache === MESSAGE_CACHE_TYPE.LOCAL) {
            localStorage.setItem(`chatbox_cache_${conversationId}`, JSON.stringify(msgs));
        }

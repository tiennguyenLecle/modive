...
import { useEpisodeContext } from './_components/Episode';
    ...
    <div className={cx(activeTab === 'community' && 'flex h-full flex-col')}>
      ...
      <div className={cx(activeTab === 'community' && 'h-0 overflow-hidden')}>
        ...
        <div className="flex flex-col gap-13 bg-white p-16">
          ...
          <div>
            <p className="whitespace-pre-wrap text-14 font-normal leading-1.66 -tracking-0.07 text-gray-00">
      ...
      <MenuTab
        ...
        tabs={[
          ...
          },
          {
            ...
            hidden: !workDetail.characters_map_key,
          },
          {
            key: 'community',

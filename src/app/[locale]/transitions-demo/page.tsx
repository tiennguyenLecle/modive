...
export default function TransitionsDemoPage() {
  ...
  return (
    <div className="container py-8">
      ...
      <div className="mt-8">
        <h2 className="mb-4 text-xl font-bold">Photo Gallery (Global Modal)</h2>
        <div className="flex gap-4">
          <Link href="/photos/1">
            <img src="https://picsum.photos/seed/1/150" alt="Photo 1" className="rounded-lg"/>
          </Link>
          <Link href="/photos/2">
            <img src="https://picsum.photos/seed/2/150" alt="Photo 2" className="rounded-lg"/>
          </Link>
        </div>
      </div>
    </div>
